package dev.gaphunter.mergeconflictleftovercompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.mergeconflictleftovercompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.mergeconflictleftovercompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Merge Conflict Leftover Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33790-merge-conflict-leftover-companion/reviews"
