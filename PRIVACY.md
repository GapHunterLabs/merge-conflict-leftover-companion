...
Merge Conflict Leftover Companion is a Gap Hunter Labs plugin for
...
**Nothing.** Merge Conflict Leftover Companion does not collect, store,
...
identifiable information. Your open file's text is read only in memory
for as long as the IDE is open.

## Network access

**None.** Merge Conflict Leftover Companion makes zero network calls
during normal operation.

## Third parties

None. Merge Conflict Leftover Companion has no third-party SDKs, no
